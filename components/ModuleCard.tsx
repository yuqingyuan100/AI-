...
export default function ModuleCard({
  ...
  return (
    <div
      className="group relative rounded-2xl border border-border-glow bg-surface/60 p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-neon-blue/30 hover:bg-surface-hover"
      style={
        {
