...
export const ROUTES: RouteData[] = [
  {
    ...
    scores: { crowd: 9, scenery: 10, convenience: 5, weather: 7, food: 7, photo: 10 },
    scoreReasons: {
      crowd: "景宁、松阳等地游客极少，属于小众秘境；清明期间云和梯田有一定人流但可控",
      scenery: "云和梯田4月灌水如镜、古堰画乡瓯江晨雾、松阳古村群、仙都鼎湖峰，景观类型极丰富",
      convenience: "距离较远约5小时，山区弯道多需谨慎驾驶，但住宿选择丰富",
      weather: "4月初丽水气温20-28°C，多云为主，偶有小雨，山区温差较大需带外套",
      food: "缙云烧饼、处州鱼头、山区野菜、畲族特色菜肴",
    ...
    weather: "4月初丽水气温15-26°C，多云为主，偶有小雨。山区昼夜温差大(约10°C)，建议带薄外套。",
  },
  {
    id: "taizhou",
    name: "台州",
    ...
    scores: { crowd: 7, scenery: 9, convenience: 6, weather: 7, food: 7, photo: 8 },
    scoreReasons: {
      crowd: "神仙居清明有一定人流但非爆满，琼台仙谷等景点游人稀少",
      scenery: "神仙居流纹岩地貌独特，天台大瀑布325米落差壮观，山海景观兼具",
      convenience: "车程约4.5小时适中，高速直达，山路段较少",
      weather: "4月台州气温16-24°C，沿海多云偶有雾，温度舒适",
      food: "天台特色农家菜、仙居杨梅（季节不对）、海鲜资源丰富",
    ...
    weather: "4月初台州气温16-24°C，沿海多云偶有海雾。温度舒适，适合户外活动。",
  },
  {
    id: "wannan",
    name: "皖南",
    ...
    scores: { crowd: 5, scenery: 9, convenience: 7, weather: 6, food: 8, photo: 9 },
    scoreReasons: {
      crowd: "宏村西递清明节人流量大，但查济、水墨汀溪等替代景点人少；川藏线沿途人不多",
      scenery: "徽派粉墙黛瓦与油菜花海的经典组合，皖南川藏线桃岭72拐惊险壮观",
      convenience: "距离适中约4小时，高速为主但川藏线山路弯急坡陡需注意",
      weather: "4月初皖南多阴雨，气温14-22°C，烟雨朦胧但需防雨",
    ...
    weather: "4月初皖南气温14-22°C，阴雨概率较高。烟雨朦胧别有韵味但需备雨具，山区温差大。",
  },
  {
    id: "qidong",
    name: "启东",
    ...
    scores: { crowd: 6, scenery: 5, convenience: 10, weather: 7, food: 9, photo: 5 },
    scoreReasons: {
      crowd: "碧海银沙清明有一定人流，但整体启东游客密度不高，非热门目的地",
      scenery: "以海滨平原为主，自然景观种类单一，缺少山水层次",
      convenience: "仅2小时车程，全程高速，距上海最近，住宿餐饮配套完善",
      weather: "4月启东气温14-20°C，海风较大，多云为主，温度偏凉",
    ...
    weather: "4月初启东气温14-20°C，海风较大体感偏凉。多云为主，需带防风保暖衣物。",
  },
];
